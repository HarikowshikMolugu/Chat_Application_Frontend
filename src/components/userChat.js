...
function UserChat(props) {
  ...
  const openChat = async (chattedUserId) => {
    try {
      ...
      setSelectedChatId(chattedUserId);
    } catch (error) {
  ...
  const Edit = () => {
    ...
    document.getElementById('username12').readOnly = false;
    document.getElementById('password12').readOnly = false;
  };
  ...
  const Save = async () => {
    try {
      ...
      document.getElementById('username12').readOnly = true;
      document.getElementById('password12').readOnly = true;
      ...
      <div className='chatList'>
        <div className='header'>
          <div className='headerTitle'>
            <p className='title1'><span><img id='titlepic' src={chatpic} alt='Chat Icon' /></span>InfiniTalk</p>
            <p className="encrypt">{encrypttxt}</p>
          </div>
          <div className='dropdown'>
            <p className='dropbtn'><img id='menu' src={menu} alt='Menu Icon' /></p>
        ...
        {showChat && (
          <>
            <div className='chatHistoryTitle'>
              <div id='backimagDiv'>
                <img id="backimg" src={back} onClick={backimgFun} alt='Back Icon' />
              </div>
            ...
            <div className='messageBox'>
              <div className='messageContainer' id='messageContainer' ref={messageContainerRef} onScroll={handleScroll}>
                      ...
                      <div className={`message ${list.side === 'left' ? 'left' : 'right'}`}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                          ...
                          {list.side === "right" && (
                            <>
                              {list.status === "Unseen" ? (
                                <img id='tickimg' src={unseen} alt='Unseen' />
                              ) : (
                                <img id='tickimg' src={seen} alt='Seen' />
                              )}
                            </>
                          )}
                        </div>
              ...
              <div className='inputContainer'>
                ...
                <button onClick={() => addChat(storedchattedUserid)}><img style={{ height: '15px', width: '15px' }} src={send} alt='Send Icon' /></button>
              </div>
            </div>
          </>
        )}
